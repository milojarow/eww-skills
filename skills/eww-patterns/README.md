...
Real-world eww widget patterns from community configs. Start here to find what you need.

## Files

| File | Contents |
|---|---|
| `SKILL.md` | Pattern selection table, core architecture principles, multi-monitor setup, reusable components |
| `BAR_PATTERNS.md` | Horizontal bar, vertical sidebar, multi-monitor bar, hover-reveal module — complete yuck + scss |
...
**Building a bar?** Read `BAR_PATTERNS.md`.
**Building a popup or overlay?** Read `POPUP_PATTERNS.md`.
...
- `eww-yuck` — syntax reference for defwindow, defwidget, defpoll, deflisten
- `eww-widgets` — built-in widget properties and magic variables
- `eww-styling` — SCSS structure and GTK CSS selectors
- `eww-troubleshooting` — when patterns don't work
